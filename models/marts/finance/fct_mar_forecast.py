...
def model(dbt, session: snowpark.Session):
    ...
    # Configure the model
    # Note: snowflake-snowpark-python is already available in Snowflake's Python runtime
    # Python packages for Snowflake are managed via Anaconda channel or requirements.txt
    dbt.config(
        materialized="table",
